...
public class OneGroupChatListFragment extends GroupChatListFragment {
                ...
                .clicked(R.id.ll_chat_list, new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if (IM.sImUtils.imOptions.onImChatListEventListener != null) {
                            ...
                            IM.sImUtils.openGroupChatActivity(getContext(), chatList.getUserName(), chatList.getTopicId());
                        }
                    }
                })
