package com.yryc.imkit.core.slim.loadmore;
...
public abstract class SlimMoreLoader extends RecyclerView.OnScrollListener {
    ...
    private void initHandler() {
        handler = new Handler();
        HandlerThread eventHandlerThread = new HandlerThread(com.yryc.imkit.core.slim.loadmore.SlimMoreLoader.class.getSimpleName() + ".Thread");
