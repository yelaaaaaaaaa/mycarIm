...
import com.yryc.imkit.widget.emoji.EmojiGridAdapter;
import com.yryc.imkit.widget.emoji.EmojiManager;
import com.yryc.imkit.widget.emoji.EmojiUtil;
    ...
    private class EmojiPageAdapter extends PagerAdapter {
        ...
        public EmojiPageAdapter() {
            ...
            for (int i = 0; i < pageSize; i++) {
                ...
                recyclerView.setLayoutManager(new GridLayoutManager(context, EmojiUtil.COLUMN));
