...
public class SmartRefreshLayout extends ViewGroup implements RefreshLayout, NestedScrollingParent, NestedScrollingChild {
    ...
    protected RefreshState mState = None;          //主状态
    protected RefreshState mViceState = None;      //副状态（主状态刷新时候的滚动状态）
...
//        }
     ...
     * 设置多功能监听器
     *
     * @param listener 建议使用 {@link com.yryc.imkit.widget.refresh.listener.SimpleMultiPurposeListener}
     * @return SmartRefreshLayout
     */
    @Override
     ...
     * 设置滚动边界
     *
     * @param boundary 建议使用 {@link com.yryc.imkit.widget.refresh.impl.ScrollBoundaryDeciderAdapter}
     * @return SmartRefreshLayout
     */
    @Override
