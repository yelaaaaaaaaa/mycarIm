...
import com.yryc.imkit.widget.gallery.adapter.GalleryPhotoAdapter;
import com.yryc.imkit.widget.gallery.model.GalleryPhotoModel;
import com.yryc.imkit.widget.gallery.model.GalleryPhotoParameterModel;
import com.yryc.imkit.widget.gallery.util.GalleryDownLoadCallBack;
import com.yryc.imkit.widget.gallery.util.GalleryDownloadThread;
import com.yryc.imkit.widget.gallery.util.GalleryScreenUtil;
...
//        boolean isFocus = requestFocus();
    ...
    private void initData() {
        ...
        for (int i = 0; i < photoList.size(); i++) {
            ...
            galleryPhoto.setOnPhotoTapListener(new PhotoViewAttacher.OnPhotoTapListener() {
                @Override
